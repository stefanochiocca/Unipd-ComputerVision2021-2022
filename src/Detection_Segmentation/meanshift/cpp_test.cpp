...
int main(int argc, char **argv)
{
    ...
    vector<vector<double> > points = load_points("/home/ralton/CLionProjects/CV_examn/meanshift/MeanShift_cpp/MeanShift_cpp-master/test.csv");
    vector<Cluster> clusters = msp->cluster(points, kernel_bandwidth);

    FILE *fp = fopen("/home/ralton/CLionProjects/CV_examn/meanshift/MeanShift_cpp/MeanShift_cpp-master/result.csv", "w");
    if(!fp){
